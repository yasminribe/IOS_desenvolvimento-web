...
if(idadeUser >= idadeMaior){
    alert(`Sua idade é ${idadeUser} anos .... VOCÊ PODE IR PRESO`)
}else{
    alert(`Sua idade é ${idadeUser} anos, você é menor de idade .... SEUS PAIS SERÃO PRESOS`)
} 
